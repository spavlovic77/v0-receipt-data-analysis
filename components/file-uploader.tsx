...
export function FileUploader({ onUpload }: FileUploaderProps) {
  ...
  const handleQrScan = useCallback(
    async (receiptId: string) => {
      ...
      try {
        // Fetch receipt data without authentication requirement
        ...
        console.log("[v0] Receipt loaded successfully for categorization")

        // Convert to string format for onUpload to allow categorization
      ...
      <div className="relative overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl p-8 md:p-12">
        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">Načítajte a kategorizujte doklady bez prihlásenia</p>
          </div>
